...
export const NOTICE_V1_0: NoticeDocument = {
  ...
  acknowledgements: [
    { id: 'role_uk_trainee', label: 'I am a UK doctor in training', required: true },
    {
      ...
      label:
        'I will anonymise patient identifiers in my reflections, in line with GMC guidance.',
      required: true,
    },
  ],
  ctaLabel: 'Create account',
  ctaDisclaimer:
    'By tapping Create account you agree to the Privacy Policy and Terms of Service.',
} as const;
