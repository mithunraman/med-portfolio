...
export const VARIANTS = {
  ...
  B: {
    ...
    redaction: deepseek(DEEPSEEK_FLASH, 'high'),
    classify: deepseek(DEEPSEEK_FLASH, 'high'),
    check_completeness: deepseek(DEEPSEEK_FLASH, 'high'),
    generate_followup: deepseek(DEEPSEEK_FLASH, 'max'),
    tag_capabilities: deepseek(DEEPSEEK_FLASH, 'high'),
    elicit_justification: deepseek(DEEPSEEK_FLASH, 'high'),
    reflect: deepseek(DEEPSEEK_FLASH, 'high'),
