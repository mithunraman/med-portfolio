...
export function shouldContinueElicitation(
  ...
  // below. The cap is sections × ATTEMPT_LIMIT (see check-completeness.node.ts), which
  // reserves room for every section's one forced first ask; keep the two in lockstep.
